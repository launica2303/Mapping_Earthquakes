...
let tectonic_plate = "https://github.com/fraxen/tectonicplates.git/<GitHub_name>/Mapping_Earthquakes/main/torontoNeighborhoods.json";
// Grabbing our GeoJSON data.
d3.json(tectonic_plate).then(function(data) {
    console.log(data);
